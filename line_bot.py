...
SUPABASE_URL = os.getenv("SUPABASE_URL", "https://vfieyjxlrpziiksyccdt.supabase.co")
SUPABASE_KEY = os.getenv("SUPABASE_KEY", "sb_publishable_udkJwGJ8zjXlEOlYszDRUg_yVD4g7ie")
